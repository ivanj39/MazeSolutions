...
public class MazeSolution
{
     ...
     * @return         
     */
    public void sM(String fn) throws Exception
    {
        int r = 0;
        char[][] mA;
        String da = "";
        ...
        sp(mA, MAZE_START_ROW, MAZE_START_COL);
        brMaze.close();
    }

    private void sp(char[][] a, int r, int c)
    {
        char d = '-';
    ...
    private void pm(char[][] m, String s, int mm)
    {
        int c = 0;
        int r = 0;
        int nc = 0;
